    ...
    <div id="quote-generator" style={{backgroundColor: currentColor}}>
      <div id="quote-box">
        ...
        <div id="links">
          ...
          <button id="new-quote" className="button" style={{backgroundColor: currentColor}} onClick={displayNewQuote}>New Quote</button>
        </div>
      </div>
      <button id="fortnite" style={{color: currentColor}} onClick={toggleQuoteType}>{`${quoteType === "regular" ? "Fortnite Mode" : "Back to Normal"}`}</button>
    </div>
  );
};