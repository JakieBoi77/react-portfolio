  ...
  useEffect(() => {
    ...
    svg
      ...
      .on("mouseover", function (event, d) {
        ...
        let tooltipString = "<span class='text'>" + d3.utcFormat('%Y - %B')(date) + '</span>' +
          '<br />' +
          "<span class='text'>Temp: " + d3.format('.1f')(dataset.baseTemperature + d.variance) + '&#8451;' + '</span>' +
          '<br />' +
          "<span class='text'>Variance: " + d3.format('+.1f')(d.variance) + '&#8451;' +'</span>';
    ...
    const legend = svg
      .append("g")
      .attr("id", "legend")
      .attr("transform", "translate(" + ((width / 2) - (legendWidth / 2)) + ", " + (margin.top + height + 50) + ")");
