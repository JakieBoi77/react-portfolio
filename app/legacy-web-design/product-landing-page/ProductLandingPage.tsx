      ...
      <header id="header">
        ...
        <nav id="nav-bar">
          <ul>
            ...
            <li>
              <a className="nav-link" href="#video-section">Video</a>
            </li>
            <li>
        ...
        <section id="features">
          <div className="feature">
            ...
            <div className="description">
              <h2>Powerful</h2>
              <p>Prisms are the strongest and most powerful materials in the world. They can used for just about anything
          ...
          <div className="feature">
            ...
            <div className="description">
              <h2>Rare</h2>
              <p>Prisms are insanley rare. It took ten thousand years to create the first prism. Even with modern science,
                theses prisms still take thousands of years to synthesize.</p>
            </div>
          </div>
          <div className="feature">
            <div className="icon">
            ...
            <div className="description">
              ...
              <p>Because of their power and rarity, all prism shipments are made using an armoured truck convoy.</p>
            </div>
          </div>
        </section>
        <section id="video-section">
          <div className="video">
            <iframe title="Obama Prism Youtube Video" id="video" src="https://www.youtube.com/embed/GpZQmtEKkQ8">
            </iframe>
          </div>
        </section>
        <section id="pricing">
          <div className="option-group">
            <div className="option">
              <h3>Obama Prism</h3>
              <img src="https://i.kym-cdn.com/photos/images/original/001/548/016/cc1.gif" alt="Obama Prism" />
              ...
              <p className="price">Price: <FaInfinity /></p>
              <button>Buy</button>
            </div>
            <div className="option">
              <h3>Obama Sphere</h3>
              <img src="https://media.tenor.com/AkQpJDh4fqEAAAAC/barack-obama-sphere.gif" alt="Trump Prism" />
          ...
          <div className="option-group">
            <div className="option">
              <h3>Obamahedron</h3>
              <img src="https://media.tenor.com/Uxeo34AJba0AAAAC/obama-obamium.gif" alt="Obamahedron" />
            ...
            <div className="option">
              ...
              <img src="https://i.kym-cdn.com/photos/images/original/001/606/405/fa6.gif" alt="Obama Tesseract" />
