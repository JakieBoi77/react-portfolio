  ...
  return (
    <section>
      ...
      <div className="flex flex-wrap flex-row items-center justify-center w-full py-16 gap-8">
        {fullStackProjects.map(({ id, projectTitle, link, github, des, picList, iconList }, index) => (
          <motion.div
            ...
            className="w-full"
          >
            <div className="flex items-center justify-center flex-col w-full rounded-[22px] p-4 bg-zinc-900">
              <p className="text-xl sm:text-3xl mt-4 mb-2 text-neutral-200">
                {projectTitle}
              </p>
              <div className="relative overflow-hidden w-full h-full pt-5 pb-20">
                <Carousel slides={picList}/>
              </div>
              <p className="text-md text-neutral-400 p-4 sm:px-14 pb-6">
                {des}
              </p>
              <div className="flex flex-row gap-4">
                ...
                >
                  <div className="flex flex-row gap-2">
                    <img src="/misc/arrow.svg" className="text-black"/>
                    Visit
                  </div>
                </Link>
                <Link
                ...
                >
                  <div className="flex flex-row gap-2">
                    <img src="/social-icons/git2.svg" className="text-black"/>
                    GitHub
                  </div>
                </Link>
              </div>
