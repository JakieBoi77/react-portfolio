...
const typographyClassNames = {
    ...
    blockquote: "mt-6 border-l-2 border-brand/70 pl-6 text-base italic leading-7 text-ink-muted",
    inlineCode:
...
function createTypographyComponent(
    ...
    const TypographyComponent = React.forwardRef<HTMLElement, TypographyProps>(
        ({ as: Component = defaultElement, className, ...props }, ref) => (
            <Component ref={ref} className={cn(baseClassName, className)} {...props} />
        ),
    )
...
const TypographyH1 = createTypographyComponent("TypographyH1", "h1", typographyClassNames.h1)

const TypographyH2 = createTypographyComponent("TypographyH2", "h2", typographyClassNames.h2)

const TypographyH3 = createTypographyComponent("TypographyH3", "h3", typographyClassNames.h3)

const TypographyH4 = createTypographyComponent("TypographyH4", "h4", typographyClassNames.h4)

const TypographyP = createTypographyComponent("TypographyP", "p", typographyClassNames.p)

const TypographyLead = createTypographyComponent("TypographyLead", "p", typographyClassNames.lead)
...
const TypographyList = createTypographyComponent("TypographyList", "ul", typographyClassNames.list)
